...
![blog image]({{ "/assets/slow-start-1.jpg" | absolute_url }})
...
![blog image]({{ "/assets/steadystate.png" | absolute_url }})
...
![blog image]({{ "/assets/bwthroughput.png" | absolute_url }})
...
![blog image]({{ "/assets/latency.png" | absolute_url }})
...
![blog image]({{ "/assets/tcp-loss.png" | absolute_url }})
...
![blog image]({{ "/assets/udp.png" | absolute_url }})
