...
You can download the VOVA appliance OVF package (OpenStack Icehouse release) [here](http://partnerweb.vmware.com/programs/vmdkimage/vova/VOVA_ICEHOUSE.ova).

![blog image]({{ "/assets/ova1.png" | absolute_url }})
...
![blog image]({{ "/assets/vova5.png" | absolute_url }})
...
![blog image]({{ "/assets/vova6.png" | absolute_url }})
