...
![components]({{ "/assets/vmware-components.png" | absolute_url }})
_Very simplified view of components fitting together_
...
![blog image]({{ "/assets/vmware-vic-marketecture.png" | absolute_url }})
_VIC Marketecture_
...
![blog image]({{ "/assets/photon_platform.png" | absolute_url }})
_Photon Platform Marketecture_
